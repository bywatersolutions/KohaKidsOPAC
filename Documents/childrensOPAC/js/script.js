...
/*  $("#category_types").wrapInner('<div class="carousel__inner">');
  ...
  $('#categories .carousel__box a').each(function(){
     parent = $(this).parent();  category = $(parent).find('h2').text(); console.log(category); $(this).attr('href', "http://michael.test.bywatersolutions.com/cgi-bin/koha/opac-search.pl?idx=kw&op=and&idx=kw&q=&op=and&idx=kw&q=&do=Search&limit=mc-loc%3ACHILD&q=" + category);
  });
